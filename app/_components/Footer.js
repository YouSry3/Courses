    ...
    >
      ...
      <ul className="mt-8 flex justify-center gap-6 sm:mt-0 lg:justify-end">
        <li>
          <a
            id='face'
            href="https://www.facebook.com/profile.php?id=100053775250318"
            rel="noreferrer"
            target="_blank"
        ...
        <li>
          <a
            id='Instagram'
            href="https://www.instagram.com/m7hmed_yousry/"
            rel="noreferrer"
            target="_blank"
            className="text-gray-700 transition hover:opacity-75"
          >
        ...
        <li>
          <a
            id='GitHub'
            href="https://github.com/mohamedsherif301"
            rel="noreferrer"
            target="_blank"
            className="text-gray-700 transition hover:opacity-75"
          >
        ...
        <li>
          <a
            id='youtube'
            href="https://www.youtube.com/@Elmajc"
            rel="noreferrer"
            target="_blank"
            className="text-gray-700 transition hover:opacity-75 "
          >
